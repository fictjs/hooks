...
describe('distribution runtime', () => {
  it.each(['esm', 'cjs'])(
    'preserves copies after timer registration failures in the built %s entry',
    (format) => {
      const fixture = resolve('test/fixtures/distribution-clipboard-timer-error.mjs');
  ...
  it.each(['esm', 'cjs'])(
    'preserves useWebSocket initial setup ownership in the built %s entry',
    (format) => {
      const fixture = resolve('test/fixtures/distribution-websocket-initial-setup-ownership.mjs');
  ...
  it.each(['esm', 'cjs'])(
    'preserves useWebSocket binaryType close ownership in the built %s entry',
    (format) => {
      const fixture = resolve(
        'test/fixtures/distribution-websocket-binarytype-close-ownership.mjs'
      );
